...
CREATE TABLE `barbero` (
  `BarberoID` int NOT NULL AUTO_INCREMENT,
  `NombreID` varchar(100) DEFAULT NULL,
  `Telefono` int DEFAULT NULL,
  `Correo` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`BarberoID`)
...
INSERT INTO `clientes` VALUES (1,'Edgar','Beltran'),(2,'Jimy','Torres');
...
INSERT INTO `ventas` VALUES (1,2550,'2025-05-15'),(2,3000,'2025-05-15'),(3,6545,'2025-05-15'),(4,5648,'2025-05-15');
...
-- Dump completed on 2025-05-29 19:46:35
